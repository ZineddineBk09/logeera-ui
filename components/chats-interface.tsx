...
const mockChats = [
  {
    id: "1",
    user: { name: "Sarah Chen", avatar: "/diverse-user-avatars.png", online: true },
  ...
  {
    id: "2",
    user: { name: "Mike Johnson", avatar: "/diverse-user-avatars.png", online: false },
  ...
  {
    id: "3",
    user: { name: "Emma Wilson", avatar: "/diverse-user-avatars.png", online: true },
...
const mockMessages = [
  ...
  },
  {
    id: "2",
    sender: "You",
    message: "No problem! Happy to have you along. Have you done rideshares before?",
    timestamp: "10:32 AM",
    isMe: true,
  },
  {
    id: "3",
    sender: "Sarah Chen",
    message: "Yes, I've done a few trips. I'm a clean and quiet passenger, and I always chip in for gas!",
    timestamp: "10:35 AM",
    isMe: false,
  },
  {
    id: "4",
    sender: "You",
    message: "Great! What time works best for you to meet? I was thinking 9 AM at the Starbucks on Market Street.",
    timestamp: "10:37 AM",
    isMe: true,
  },
  {
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mb-1">
                      ...
                      <span className="text-xs text-muted-foreground">• {chat.trip.date}</span>
                    </div>
