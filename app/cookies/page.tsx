...
export const metadata: Metadata = {
  title: 'Cookie Policy',
  description:
    'Learn about how Logeera uses cookies and similar technologies to improve your experience and provide our services.',
  openGraph: {
    title: 'Cookie Policy - Logeera',
    description:
      'Learn about how Logeera uses cookies and similar technologies.',
    url: '/cookies',
  },
  twitter: {
    title: 'Cookie Policy - Logeera',
...
const cookieTypes = [
  {
    ...
    badge: 'Required',
    description:
      'These cookies are necessary for the website to function properly. They enable basic features like page navigation, authentication, and security.',
    examples: [
      'User authentication',
      'Session management',
      'Security features',
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">
                Manage your cookie preferences in your account settings. You can
          ...
          <div className="bg-primary/5 rounded-lg p-4">
            <h4 className="mb-2 font-semibold">Third-Party Cookies</h4>
            <p className="text-muted-foreground text-sm">
              We use Google Maps for location services and may use analytics
              services. These services have their own privacy policies and
              cookie practices.
            </p>
          </div>
        </CardContent>
