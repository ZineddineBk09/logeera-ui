...
export const metadata: Metadata = {
  ...
  description:
    'Learn how Logeera protects your privacy and handles your personal data. Understand our data collection, usage, and sharing practices.',
  openGraph: {
    title: 'Privacy Policy - Logeera',
    description:
      'Learn how Logeera protects your privacy and handles your personal data.',
    url: '/privacy',
  },
  twitter: {
    title: 'Privacy Policy - Logeera',
...
const privacySections = [
  {
    ...
    icon: Database,
    content:
      'We collect information you provide directly (name, email, phone), usage data (trips, locations), and device information to provide our services safely and effectively.',
  },
  {
    title: 'How We Use Your Information',
    icon: Eye,
    content:
      'Your information helps us connect you with other users, process payments, ensure safety, improve our services, and communicate important updates.',
  },
  {
    title: 'Information Sharing',
    icon: Users,
    content:
      'We share limited information with trip participants for coordination, with service providers for platform operations, and with authorities when required by law.',
  },
  {
    title: 'Data Security',
    icon: Lock,
    content:
      'We use industry-standard security measures including encryption, secure servers, and regular security audits to protect your personal information.',
  },
  {
    title: 'Location Data',
    icon: Globe,
    content:
      'Location data is used to facilitate rides, provide safety features, and improve our services. You can control location sharing through your device settings.',
  },
  {
    title: 'Your Rights',
    icon: Shield,
    content:
      'You can access, update, or delete your personal information anytime. You also have the right to data portability and can request information about our data practices.',
  },
];
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">
                View and update your personal information in your profile
                settings.
              </p>
            </div>
            <div className="space-y-2">
